 ...
 return (
    <Box sx={{ px: { xs: 2, md: 6 }, py: 6 }}>    
      ...
      <Box ref={refScroll} sx={{display: "flex", gap: 2, overflowX: "auto", scrollBehavior: "smooth", "&::-webkit-scrollbar": {display: "none"},}}>
        {data.map((category) =>        
            <Card key={category.id} elevation={4} sx={{textAlign: "center", display: "flex", justifyContent: "center",alignItems: "center", p: 2, my:3, minWidth: { xs: 150, sm: 140 }, border: "1px solid rgba(0, 0, 0, 0.3)", cursor: "pointer", transition: "0.3s", 
