...
export default function Login() {
  ...
  return (     
      <Grid container spacing={3} sx={{my: "60px"}}>
        ...
        <Box className={`${styles.slideEnterLeft} ${animate ? styles.active : ""}`} sx={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", margin: "auto"}}>
                ...
                <Box sx={{ width:  "100%", maxWidth: 400 }}>           
                  ...
                  <Box onSubmit={handleSubmit(registerForm)} component={"form"} sx={{mt: 5, display: "flex", flexDirection: "column", gap: 3}}>              
                    ...
                    <Box sx={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                      <LoadingButton loading={isSubmitting} loadingIndicator="Processing..." variant="contained" type="submit" sx={{backgroundColor: "#DB4444", py: "13px", px:"45px", mx: "5px" }} endIcon={<SendIcon />}>Log in</LoadingButton>
