...
export default function Register() {
  ...
  return (     
      <Grid container spacing={3} sx={{my: "60px"}}>
        <Grid item xs={12} md={6} sx={{display: { xs: "none", md: "flex" }, justifyContent: "center", alignItems: "center", height: "111vh"}}> 
          <Box component="img" src={sideImage} alt="Side" sx={{ width: "100%", height: "100%", objectFit: "cover"}} className= {styles.image} />
        </Grid>
        
        <Box className={`${styles.slideEnterRight} ${animate ? styles.active : ""}`} sx={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", margin: "auto"}}>
          ...
          <Grid item xs={12} md={6} sx={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", margin: "auto" ,p: 4,}}>
              ...
              <Box sx={{ width:  "100%", maxWidth: 400 }}>           
                ...
                <Box onSubmit={handleSubmit(registerForm)} component={"form"} sx={{mt: 5, display: "flex", flexDirection: "column", gap: 3}}>
                  ...
                  <LoadingButton loading={isSubmitting} loadingIndicator="Processing..." variant="contained" type="submit" sx={{backgroundColor: "#DB4444", py: "13px", px:"45px", mx: "5px" }} endIcon={<SendIcon />}>Create Account</LoadingButton>
